...
import 'package:vansales/screen/purchase_save_page.dart';
...
class PurchaseAddPage extends StatefulWidget {
  CustomerSupplierModel supplier;

  PurchaseAddPage({Key? key, required this.supplier}) : super(key: key);

  @override
  _PurchaseAddPageState createState() => _PurchaseAddPageState(supplier);
}

class _PurchaseAddPageState extends State<PurchaseAddPage> {
  _PurchaseAddPageState(CustomerSupplierModel _supplier) {
    supplier = _supplier;
  }
                    ...
                    if (itemlist.isNotEmpty) {
                      ...
                      if (_isRepeat) {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => PurchaseSavePage(
                                    itemlist: itemlist, supplier: supplier)));
                      }
                    } else {
                    ...
                    ElevatedButton(
                        onPressed: () {
                          if (item.text.isNotEmpty &&
                              ...
                              bprice.text.isNotEmpty) {
                            itemlist.add({
                              "id": itemId,
                              "name": item.text,
                              "quantity": int.parse(quantity.text),
                              "vat": itemvat,
                              "price": double.parse(bprice.text)
                            });
                            selecteditemlist();
                            item.text = "";
                            quantity.text = "";
